...
export class GenericReportFiltersDto {
  @ApiProperty({
  ...
  @ApiProperty({
    description: 'Status filter (flexible for different report types)',
    example: 'current_stock',
    required: false,
  })
  @IsOptional()
  @IsString()
  ...
  @ApiProperty({
    description: 'Supplier filter for reports',
